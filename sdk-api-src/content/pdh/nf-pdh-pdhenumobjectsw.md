...
description: Returns a list of objects available on the specified computer or in the specified log file. To use handles to data sources, use the PdhEnumObjectsH function. (Unicode)
helpviewer_keywords: ["FALSE", "PERF_DETAIL_ADVANCED", "PERF_DETAIL_EXPERT", "PERF_DETAIL_NOVICE", "PERF_DETAIL_WIZARD", "PdhEnumObjects", "PdhEnumObjects function [Perf]", "PdhEnumObjectsW", "TRUE", "_win32_pdhenumobjects", "base.pdhenumobjects", "pdh/PdhEnumObjects", "pdh/PdhEnumObjectsW", "perf.pdhenumobjects"]
