...
description: Replaces certain folder names in a fully qualified path with their associated environment string. (Unicode)
helpviewer_keywords: ["PathUnExpandEnvStrings", "PathUnExpandEnvStrings function [Windows Shell]", "PathUnExpandEnvStringsW", "_win32_PathUnExpandEnvStrings", "shell.PathUnExpandEnvStrings", "shlwapi/PathUnExpandEnvStrings", "shlwapi/PathUnExpandEnvStringsW"]
...
f1_keywords:
 ...
 - shlwapi/PathUnExpandEnvStringsW
dev_langs:
 - c++
topic_type:
 - APIRef
