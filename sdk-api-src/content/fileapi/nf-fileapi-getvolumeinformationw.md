...
| **FILE_SUPPORTS_HARD_LINKS**<br>0x00400000 | The specified volume supports hard links. For more information, see [Hard Links and Junctions](/windows/desktop/FileIO/hard-links-and-junctions).<br/><br/>**Windows Server 2008, Windows Vista, Windows Server 2003 and Windows XP:** This value is not supported until Windows Server 2008 R2 and Windows 7. |
