...
description: Retrieves the name of the active input locale identifier (formerly called the keyboard layout) for the calling thread. (ANSI)
...
f1_keywords:
 ...
 - winuser/GetKeyboardLayoutNameA
dev_langs:
 - c++
topic_type:
 - APIRef
