...
description: Provides default processing for any window messages that the window procedure of a multiple-document interface (MDI) frame window does not process. (Unicode)
helpviewer_keywords: ["DefFrameProc", "DefFrameProc function [Windows and Messages]", "DefFrameProcW", "_win32_DefFrameProc", "_win32_defframeproc_cpp", "winmsg.defframeproc", "winui._win32_defframeproc", "winuser/DefFrameProc", "winuser/DefFrameProcW"]
