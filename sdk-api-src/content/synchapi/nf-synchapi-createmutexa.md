...
helpviewer_keywords: ["CreateMutexA", "synchapi/CreateMutexA"]
...
See <a href="/windows/desktop/Sync/using-mutex-objects">Using Mutex Objects</a> for an example of <b>CreateMutex</b>.
