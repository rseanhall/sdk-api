...
description: The SetupDiBuildClassInfoListEx function returns a list of setup class GUIDs that includes every class installed on the local system or a remote system. (ANSI)
helpviewer_keywords: ["SetupDiBuildClassInfoListExA", "di-rtns_beaf3abb-65f5-4b7a-b0a1-5b8eab484eff.xml"]
